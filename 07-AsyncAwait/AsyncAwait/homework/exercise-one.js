...
function problemA () {
  ...
  async function asyncReadFile () {
    return await promisifiedReadFile('poem-one/stanza-01.txt');
  };
  asyncReadFile().then(stanza => blue(stanza));
}
...
function problemB () {
  ...
  // AsyncAwait version
  async function asyncReadFile2 (file) {
    return await promisifiedReadFile(file);
  };
  asyncReadFile2('poem-one/stanza-02.txt').then(stanza => blue(stanza));
  asyncReadFile2('poem-one/stanza-03.txt').then(stanza => blue(stanza));
}
...
function problemC () {
  ...
  asyncReadFile2('poem-one/stanza-02.txt').then(stanza => {
    blue(stanza);
    asyncReadFile2('poem-one/stanza-03.txt').then(stanza => {
      blue(stanza);
      console.log('done');
    });
  });
...
function problemD () {
  ...
  asyncReadFile2('poem-one/wrong-file-name.txt')
...
function problemE () {
  ...
  asyncReadFile2('poem-one/stanza-03.txt')
    .then(stanza => {
      blue(stanza);
    })
    .then(() => asyncReadFile2('poem-one/wrong-file-name.txt')
      .then(stanza => {
        blue(stanza);
    }))
    .catch((err) => {
